    ...
    <section id="hero" class="position-relative overflow-hidden py-4" style="background: linear-gradient(rgba(0,0,0,0.8), rgba(0,0,0,0.8)),url(/images/banner-img.jpg)">
        <div class="container py-5">
            <div class="row justify-content-center align-items-center py-5">
                <div class=" col-md-5">
                    <form class="hero-form p-5" action="/op" method="post">
                        <h3>Tornar Admin</h3>
                        <div class="mb-4">
                            <label for="InputUser" class="form-label mb-0">Informe o Usuário</label>
                            <input type="text" class="form-control border-0" id="InputUser" name="user">
                        </div>
                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary btn-lg">Autorizar</button>
                        </div>
                        <div class="d-flex justify-content-end">
                        <a href="/admin"><button type="button" class="btn btn-primary-sm">Voltar</button></a>
                    </div>
                    </form>
                </div>
            </div>
