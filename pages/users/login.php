            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav align-items-center justify-content-end flex-grow-1 pe-3">
                        ...
                        <a href="/users/register"><button type="button" class="btn btn-danger">Registre-se</button></a>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section id="hero" class="position-relative overflow-hidden py-4"
        ...
        <div class="container py-5">
            <div class="row justify-content-center align-items-center py-5">
                <div class=" col-md-5">
                    <form class="hero-form p-5" action="/login" method="post">
                        <h3>Fazer Login</h3>
                        <div class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control border-0" id="InputPassword" name="password">
                        </div>
                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary btn-lg">ENTRAR</button>
                        </div>
                        <a href="/users/register" class="ms-6">
                            <p>Registre-se</p>
                        </a>
                    </form>
                </div>
