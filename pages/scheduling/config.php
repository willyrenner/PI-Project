...
<body data-bs-spy="scroll" data-bs-target="#header-nav" tabindex="0">
    ...
    <section id="hero" class="position-relative overflow-hidden py-4" style="background: linear-gradient(rgba(0,0,0,0.8), rgba(0,0,0,0.8)),url(/images/banner-img.jpg)">
        <div class="container py-5">
            <div class="row justify-content-center align-items-center py-5">
                <div class=" col-md-5">
                    <form class="hero-form p-5" action="/change" method="post">
                        <h3>Alterar Senha</h3>
                        <div class="mb-4">
                            <label for="InputUser" class="form-label mb-0">Informe o email</label>
                            <input type="text" class="form-control border-0" id="InputUser" name="email">
                        </div>
                        <div class="mb-3">
                            <label for="InputPassword" class="form-label mb-0">Senha Antiga</label>
                            <input type="password" class="form-control border-0" id="oldpassword" name="oldpassword">
                        </div>
                        <div class="mb-3">
                            <label for="InputPassword" class="form-label mb-0">Nova Senha</label>
                            <input type="password" class="form-control border-0" id="newpassword" name="newpassword" onkeyup="verifyPass()">
                        </div>
                        <div class="mb-3">
                            <label for="InputPassword" class="form-label mb-0">Confirmar Senha</label>
                            <input type="password" class="form-control border-0"  id="verifypassword" name="verifypassword" onkeyup="verifyPass()">
                        </div>
                        <p class="form-label" id="verification"></p>
                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary btn-lg">Mudar</button>
                        </div>
                        <div class="d-flex justify-content-end">
                        <a href="/dashboard"><button type="button" class="btn btn-primary-sm">Voltar</button></a>
                    </div>
                    </form>
                </div>
            </div>
    ...
    <script>
		function verifyPass() {
			...
			var check = document.getElementById('verifypassword').value;
            ...
            <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 my-5 py-5 ">
                ...
                <div class="col-md-3 ">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item d-flex mb-3">
                            <iconify-icon class="contact-icon pe-3" icon="ion:call"></iconify-icon><a href="#" class="nav-link p-0 "> +55 (84) 4002-8922 </a>
                        </li>
                        <li class="nav-item d-flex mb-3">
                            <iconify-icon class="contact-icon pe-3" icon="ion:mail"></iconify-icon><a href="#" class="nav-link p-0 "> contato@emgmanipulator.com </a>
                        </li>
