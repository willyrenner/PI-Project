    ...
    <section id="hero" class="position-relative overflow-hidden py-4" style="background: linear-gradient(rgba(0,0,0,0.8), rgba(0,0,0,0.8)),url(/images/banner-img.jpg)">
        <div class="container py-5">
            <div class="row justify-content-center align-items-center py-5">
                <div class=" col-md-5">
                    <form class="hero-form p-5" action="/saveagend" method="post">
                        <h3>Realizar Agendamento</h3>
                        <div class="mb-4">
                            <label for="InputUser" class="form-label mb-0">Nome</label>
                            <input type="text" class="form-control border-0" id="InputFiInputUserrstName" name="nome">
                        </div>
                        <div class="mb-3">
                            <p class="form-label">Data</p>
                            <select class="form-select form-select-sm" name="date" aria-label=".form-select-sm example">
                                <option selected disabled id="date">Datas Disponíveis</option>
                                <option value="2024-09-30">30/09/2024</option>
                                <option value="2024-10-30">30/10/2024</option>
                                <option value="2024-11-30">30/11/2024</option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <p class="form-label">Horário</p>
                            <select class="form-select form-select-sm" name="time" aria-label=".form-select-sm example">
                                <option selected disabled>Horários Disponíveis</option>
                        ...
                        <div class="mb-0 d-flex justify-content-end">
                            <a href="/dashboard"><button type="button" class="btn btn-primary-sm mt-3">Voltar</button></a>
                        </div>
