    ...
    <section id="hero" class="position-relative overflow-hidden py-4"
        ...
        <div class="container py-5">
            <div class="row justify-content-center align-items-center py-5">
                <div class="col-md-3">
                    <h1 class="text-white">Painel de Admin</h1>
                    <div class="mb-3">
                        <a href="/userslist"><button type="button" class="btn btn-danger">Listar Todos Os Usuários</button></a>
                    </div>
                    <div class="mb-3">
                        <a href="/agendList"><button type="button" class="btn btn-danger">Listar Agendamentos</button></a>
                    </div>
                    <div class="mb-3">
                        <a href="/permissions"><button type="button" class="btn btn-danger">Gerenciar Permissões</button></a>
                    </div>
                </div>
            </div>
        </div>
