    ...
    <section id="hero" class="position-relative overflow-hidden py-4"
        ...
        <div class="container py-5">
            <div class="row justify-content-center align-items-center py-5">
                <div class="col-md-3">
                    <h1 class="text-white">Painel de Usuário</h1>
                    <div class="mb-3">
                        <a href="/agendar"><button type="button" class="btn btn-danger">Realizar Agendamento</button></a>
                    </div>
                    <div class="mb-3">
                        <a href="/veragendamentos"><button type="button" class="btn btn-danger">Listar Agendamentos</button></a>
                    </div>
                    <div class="mb-3">
                        <a href="/config"><button type="button" class="btn btn-danger">Configurações da Conta</button></a>
                    </div>
                </div>
            </div>
        </div>
